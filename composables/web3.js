...
const web3CronosRpc = new Web3("https://1rpc.io/cro")
const  web3EthRpc = new Web3("https://1rpc.io/eth")

export default {web3EthRpc,web3InoRpc,web3CronosRpc,web3PolygonRpc}
